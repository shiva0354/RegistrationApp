...
public class AdminLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("RegistrationApp | Login");
        setResizable(false);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/pexels-photo-417222 (1).jpeg"))); // NOI18N
    ...
    public void login(){
       String s1 = username.getText();
        ...
        try{ 
                ...
                ResultSet rs=db.dbconnect.st.executeQuery("select * from admin where username='"+s1+"' and pass = '"+s2+"' ");
            ...
            JOptionPane.showMessageDialog(null, "please fill your credentials");
          }
    }
